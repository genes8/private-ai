...
- **GET /settings**: Retrieves current application settings with live metadata
...
**Section sources**
- [settings_routes.py:216-286](file://safe4ai-pilot/app/api/settings_routes.py#L216-L286)
...
CheckModels --> |No| Error["HTTP 422: Pull Required Models"]
...
- **TTL**: 15 seconds for live metadata
...
CheckOllama --> |Failure| Error1[HTTP 422 Error]
SanitizeModels --> |Failure| Error1
ProbeCloud --> |Failure| Error1
CheckRanges --> |Failure| Error2[HTTP 422 Error]
CheckDimensions --> |Failure| Error3[HTTP 409 Error]
Error1 --> Rollback[Rollback Database Transaction]
Error2 --> Rollback
Error3 --> Rollback
...
### Caching Strategy
- **Live Metadata Cache**: 15-second TTL for frequently accessed data
