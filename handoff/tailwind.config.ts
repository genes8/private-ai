// private-ai · Tailwind config extension
// Drop this into your tailwind.config.ts → theme.extend
// (or merge with what you have).
...
const tokens = {
  ...
  boxShadow: {
    ...
    pop: "0 12px 40px rgba(20,22,26,.12), 0 2px 6px rgba(20,22,26,.06)",
  },
  letterSpacing: {
    tight: "-0.02em",
    snug:  "-0.012em",
